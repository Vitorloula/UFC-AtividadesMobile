...
object AppColors {
    val primary = Color.Green       // Azul médio
    ...
    val surface = Color.Gray       // Branco puro para superfícies
    val onSurface = Color.DarkGray     // Preto para texto em superfícies claras
